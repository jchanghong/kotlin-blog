    ...
    $.flavr = function () {
        ...
        */
        ...
        var build = function () {
            ...
            if (true == me.settings.closeOverlay) overlay.on('click', function () {
                me.close();
            });
            ...
            if (true == me.settings.autoclose) setTimeout(function () {
                me.close()
            }, me.settings.timeout);
            ...
            */
            if ('confirm' == me.settings.dialog) {
                me.defaults.buttons = {
                    confirm: {
                        text: 'Confirm', style: 'danger', addClass: null,
                        action: function () {
                    ...
                    cancel: {
                        text: 'Cancel', style: 'default', addClass: null,
                        action: function () {
            ...
            */
            if ('form' == me.settings.dialog) {
                ...
                me.defaults.buttons = {
                    submit: {
                        text: 'Submit', style: 'danger', addClass: null,
                        action: function () {
                            form.submit();
                            return false;
                        }
            ...
            */
            if (me.settings.buttons !== false) $.each(me.settings.buttons, function (btnkey, btnvalue) {
                ...
                if (isobj(this)) {
                    var item = $.extend({}, btn_defaults, this);
                    /* Merge button patterns */
        ...
        me.bounce = function (fn) {
            me.animate('bounce', fn);
            return me;
        };
        me.shake = function (fn) {
            me.animate('shake', fn);
            return me;
        };
        me.pulse = function (fn) {
            me.animate('pulse', fn);
            return me;
        };
        me.rubberBand = function (fn) {
            me.animate('rubberBand', fn);
            return me;
        };
        me.wobble = function (fn) {
            me.animate('wobble', fn);
            return me;
        };
        me.swing = function (fn) {
            me.animate('swing', fn);
            return me;
        };
        me.flash = function (fn) {
            me.animate('flash', fn);
            return me;
        };
        me.tada = function (fn) {
        ...
        me.onShow = function (callback) {
            if (fn(callback)) me.settings.onShow = callback;
            return me;
        };
        me.onClose = function (callback) {
            if (fn(callback)) me.settings.onClose = callback;
            return me;
        };
        me.onHide = function (callback) {
            if (fn(callback)) me.settings.onHide = callback;
            return me;
        };
